...
START_MSG = environ.get("START_MSG", JARVIS.DEFAULT_MSG)
BOT_PICS = (environ.get('PICS', 'https://telegra.ph/file/4b5095e9ce77a82e56a45.jpg')).split()
SUPPORT = environ.get("SUPPORT", "https://t.me/Mohan_MVT")
SPELL_MODE = is_enabled((environ.get('SPELL_MODE', "on")), True)
SET_SPEL_M = environ.get("SPELL_MODE_TEXT", JARVIS.SPELL_CHECK)
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", None))
DATABASE_URI = environ.get("DATABASE_URI", None)
FORCE = environ.get('FORCES_SUB')
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", JARVIS.FILE_CAPTIONS)
DEV_NAME = environ.get("DEV_NAME", "MOHAN_MVT")
...
DATABASE_NAME = environ.get("DATABASE_NAME", 'MVT_Movie_Searcher_Bot')
