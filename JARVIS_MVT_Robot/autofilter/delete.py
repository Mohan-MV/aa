...
@JARVIS_MVT_Robot.on_message(Worker.command('delete') & Worker.user(ADMINS))
...
@JARVIS_MVT_Robot.on_message(Worker.command('deleteall') & Worker.user(ADMINS))
...
@JARVIS_MVT_Robot.on_callback_query(Worker.regex(r'^autofilter_delete'))
