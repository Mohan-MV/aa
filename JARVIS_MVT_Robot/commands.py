...
from JARVIS_MVT_Robot.database.broadcast_db import Database

db = Database()


@JARVIS_MVT_Robot.on_message(Worker.private & Worker.command(["start"]))
...
@JARVIS_MVT_Robot.on_message(Worker.private & Worker.command(["help"]))
async def help(bot, message):
    ...
    await message.reply_photo(
        ...
        caption=JARVIS.HELP_MSG.format(mention=message.from_user.mention),
        reply_markup=InlineKeyboardMarkup(button))
      
@JARVIS_MVT_Robot.on_message(Worker.private & Worker.command(["about"]))
async def about(bot, message):
    ...
    await message.reply_photo(
        photo = choice(BOT_PICS),
        caption=JARVIS.ABOUT_MSG.format(mention=message.from_user.mention, bot_name=bot_info.BOT_NAME, bot_username=bot_info.BOT_USERNAME, dev_name=DEV_NAME),
        reply_markup=InlineKeyboardMarkup(button))
